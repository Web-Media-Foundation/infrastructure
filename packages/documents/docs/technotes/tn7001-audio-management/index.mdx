...
To handle these complex problem Web Media Foundation created a consistence audio
experience across all major browser platforms. This feature is enabled by
[`@web-media/audio-station`](/api/audio-station) and
[`@web-media/phonograph`](/api/phonograph),
...
method to
[interact with the manager](https://github.com/Web-Media-Foundation/infrastructure/blob/bbc22e46471e4516333525819a24b111c167b9ed/packages/core-manager/src/episodeCore.ts#L105).
...
You can find
[related source code from here](https://github.com/Web-Media-Foundation/infrastructure/blob/bbc22e46471e4516333525819a24b111c167b9ed/packages/core-manager/src/episodeCore.ts#L343-L346).

# Architecture

Audio is managed in a three level model, with different kind of audio backend:

- **Audio Host**: There is an audio host [for each asset](https://github.com/Web-Media-Foundation/infrastructure/blob/df61508153b79018f530f4552b8fbc72df341569/packages/core-manager/src/instance.ts#L110)
  called [`AudioHost`](https://github.com/Web-Media-Foundation/infrastructure/blob/df61508153b79018f530f4552b8fbc72df341569/packages/core-manager/src/audio/audioHost.ts#L152),
  it will handle resource loading, playback, destroy, volume manage and subtitle
  management for different audio files.

* [**LoadableAudioElement**](https://github.com/Web-Media-Foundation/infrastructure/blob/df61508153b79018f530f4552b8fbc72df341569/packages/core-manager/src/audio/audioHost.ts#L22):
...
Web Media Foundation has two builds in implementations for different use cases, The
...
For developers that using Web Media Foundation Studio, open the resource tab of the resource
