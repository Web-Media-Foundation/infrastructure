...
Resource management is the core feature of the Web Media Foundation, it serves as a
...
![The resource management interface of the Web Media Foundation](./images/resource-management.png)
