...
To make sure the Web Media Foundation Studio could run correctly, the first task we should
...
- **Notes:** A human readable note to record some useful information for other
  developers, this is not used in the Web Media Foundation Player or Client SDK.
