...
The project structure of the Web Media Foundation includes:
...
- **A code folder:** For saving your interactive programs, Web Media Foundation Studio will
...
- **Download Resource Source:** If your team have deployed the content auth
  service of the Web Media Foundation, users can backup your database to the cloud
...
- **New Resource Source:** Creating a new resource source, this will help you
  build a new resource structure of the Web Media Foundation.
...
to manually clone the code, since it's not managed by the Web Media Foundation Studio.
