...
Web Media Foundation Studio supports debugging your interactive program in the realtime by
...
program development related features of the Web Media Foundation.
...
- **Resource Host:** The domain or the IP address and the port of the resource
  manager server, the Web Media Foundation Studio will start an HTTP server on your local
...
- **Act Point Host:** The domain or the IP address of the development server of
  the interactive program, the default value provided by `@web-media/ap-pack` is
